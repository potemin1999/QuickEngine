...
int clewInit(const char *path) {
    ...
    __clewGetSupportedImageFormats = (PFNCLGETSUPPORTEDIMAGEFORMATS) CLEW_DYNLIB_IMPORT(module,
    ...
    __clewSetMemObjectDestructorCallback = (PFNCLSETMEMOBJECTDESTRUCTORCALLBACK) CLEW_DYNLIB_IMPORT(module,
    ...
    __clewCreateProgramWithSource = (PFNCLCREATEPROGRAMWITHSOURCE) CLEW_DYNLIB_IMPORT(module,
                                                                                      "clCreateProgramWithSource");
    __clewCreateProgramWithBinary = (PFNCLCREATEPROGRAMWITHBINARY) CLEW_DYNLIB_IMPORT(module,
    ...
    __clewEnqueueCopyImageToBuffer = (PFNCLENQUEUECOPYIMAGETOBUFFER) CLEW_DYNLIB_IMPORT(module,
                                                                                        "clEnqueueCopyImageToBuffer");
    __clewEnqueueCopyBufferToImage = (PFNCLENQUEUECOPYBUFFERTOIMAGE) CLEW_DYNLIB_IMPORT(module,
    ...
    __clewGetExtensionFunctionAddress = (PFNCLGETEXTENSIONFUNCTIONADDRESS) CLEW_DYNLIB_IMPORT(module,
