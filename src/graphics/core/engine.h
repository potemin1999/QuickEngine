...
#include "graphics/core/geometry/geometry_pass.h"
#include "graphics/core/lighting/ssao_pass.h"
#include "glad/glad.h"
#include "camera.h"
#include <list>
#include <stdio.h>
...
namespace QEGraphics {
    ...
    public:
        ...
        static void
        genFBOTexture(unsigned int *handle, int width, int height, unsigned attachment, int min_f, int max_f);

        static void
        genSSAOTexture(unsigned int *handle, int width, int height, unsigned attachment, int min_f, int max_f);
