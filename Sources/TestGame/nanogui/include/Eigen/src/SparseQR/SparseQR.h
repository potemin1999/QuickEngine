...
/**
  ...
  */
    ...
    public:
        SparseQR() : m_analysisIsok(false), m_lastError(""), m_useDefaultThreshold(true), m_isQSorted(false),
                     m_isEtreeOk(false) {}
        ...
        /** Construct a QR factorization of the matrix \a mat.
          ...
          * \sa compute()
          */
        explicit SparseQR(const MatrixType &mat) : m_analysisIsok(false), m_lastError(""), m_useDefaultThreshold(true),
        ...
        */
        ...
        bool _solve_impl(const MatrixBase <Rhs> &B, MatrixBase <Dest> &dest) const {
            ...
            y.topRows(rank) = this->matrixR().topLeftCorner(rank, rank).template triangularView<Upper>().solve(
                    b.topRows(rank));
...
/** \brief Performs the numerical QR factorization of the input matrix
  ...
  */
    ...
    void SparseQR<MatrixType, OrderingType>::factorize(const MatrixType &mat) {
        ...
        IndexVector Ridx(n), Qidx(
                m);                             // Store temporarily the row indexes for the current column of R and Q
    ...
    namespace internal {
        ...
        struct Assignment<DstXprType, SparseQRMatrixQReturnType<SparseQRType>, internal::assign_op<typename DstXprType::Scalar, typename DstXprType::Scalar>, Sparse2Sparse> {
            ...
            static void
            run(DstXprType &dst, const SrcXprType &src, const internal::assign_op<Scalar, Scalar> &/*func*/) {
