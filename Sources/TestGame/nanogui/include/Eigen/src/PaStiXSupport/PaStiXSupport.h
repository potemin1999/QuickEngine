...
/** \ingroup PaStiXSupport_Module
  ...
  */
    ...
    namespace internal {
        ...
        void
        eigen_pastix(pastix_data_t **pastix_data, int pastix_comm, int n, int *ptr, int *idx, float *vals, int *perm,
        ...
        void
        eigen_pastix(pastix_data_t **pastix_data, int pastix_comm, int n, int *ptr, int *idx, double *vals, int *perm,
        ...
        void eigen_pastix(pastix_data_t **pastix_data, int pastix_comm, int n, int *ptr, int *idx,
...
// Users should not used this class directly. 
    ...
    public:
        ...
        PastixBase() : m_initisOk(false), m_analysisIsOk(false), m_factorizationIsOk(false), m_pastixdata(0),
                       m_size(0) {
            init();
        }
