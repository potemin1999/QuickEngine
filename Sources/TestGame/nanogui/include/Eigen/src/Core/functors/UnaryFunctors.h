...
/** \internal
  ...
  */
        ...
        struct scalar_opposite_op {
            ...
            packetOp(const Packet &a) const { return internal::pnegate(a); }
        };
...
/** \internal
  ...
  */
        ...
        struct scalar_abs_op {
            ...
            operator()(const Scalar &a) const { return numext::abs(a); }
...
/* Avoid recomputing abs when we know the score and they are the same. Not a true Eigen functor.  */
        ...
        struct abs_knowing_score {
            ...
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const result_type
            operator()(const Scalar &a, const Score &) const { return numext::abs(a); }
        };
        ...
        struct abs_knowing_score<Scalar, typename scalar_score_coeff_op<Scalar>::Score_is_abs> {
            ...
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const result_type
            operator()(const Scal &, const result_type &a) const { return a; }
        };
...
/** \internal
  ...
  */
        ...
        struct scalar_cast_op {
            ...
            operator()(const Scalar &a) const { return cast<Scalar, NewType>(a); }
        };
