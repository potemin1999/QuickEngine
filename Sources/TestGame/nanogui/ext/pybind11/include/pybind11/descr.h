...
NAMESPACE_BEGIN(pybind11)
    NAMESPACE_BEGIN(detail)
        ...
        class descr {
            template<size_t Size1_, size_t Size2_> friend
            class descr;
        ...
        public:
            ...
            operator+(const descr<OtherSize1, OtherSize2> &other) const {
                return concat(other,
                              make_index_sequence<Size1>(),
                              make_index_sequence<Size2>(),
        ...
        constexpr descr<Size - 1, 0> _(char const(&text)[Size]) {
...
// Ternary description (like std::conditional)
        ...
        auto constexpr concat(descr<Size1, Size2> descr) { return descr; }

        template<size_t Size1, size_t Size2, typename... Args>
        auto constexpr concat(descr<Size1, Size2> descr, Args &&... args) { return descr + _(", ") + concat(args...); }

        template<size_t Size1, size_t Size2>
        auto constexpr type_descr(descr<Size1, Size2> descr) { return _("{") + descr + _("}"); }
