...
#undef EIGEN_DOC_UNARY_ADDONS
        ...
        const ArrayWrapper<const Derived> array() const { return ArrayWrapper<const Derived>(derived()); }
...
/////////// Geometry module ///////////
        ...
        enum {
            ...
            ColsAtCompileTime == 1 && RowsAtCompileTime == 1 ? ((internal::traits<Derived>::Flags & RowMajorBit) ==
                                                                RowMajorBit ? Horizontal : Vertical)
