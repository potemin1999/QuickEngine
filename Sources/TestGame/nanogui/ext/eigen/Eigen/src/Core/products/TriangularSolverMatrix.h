                ...
                for (Index j2 = 0; j2 < cols; j2 += subcols) {
                    ...
                    for (Index k1 = 0; k1 < actual_kc; k1 += SmallPanelWidth) {
                        ...
                        pack_rhs(blockB + actual_kc * j2, other.getSubMapper(startBlock, j2), actualPanelWidth,
                                 actual_cols, actual_kc, blockBOffset);
                        ...
                        if (lengthTarget > 0) {
                            ...
                            gebp_kernel(other.getSubMapper(startTarget, j2), blockA, blockB + actual_kc * j2,
                                        lengthTarget, actualPanelWidth, actual_cols, Scalar(-1),
                ...
                // R2 -= A21 * B => GEPP
                {
                    ...
                    for (Index i2 = start; i2 < end; i2 += mc) {
                        ...
                        if (actual_mc > 0) {
                            ...
                            gebp_kernel(other.getSubMapper(i2, 0), blockA, blockB, actual_mc, actual_kc, cols,
                                        Scalar(-1), -1, -1, 0, 0);
                        }
                    }
                }
