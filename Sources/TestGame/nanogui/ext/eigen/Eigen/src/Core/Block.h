...
namespace Eigen {
    ...
    namespace internal {
        ...
        enum {
            ...
            Flags =
            (traits<XprType>::Flags & (DirectAccessBit | (InnerPanel ? CompressedAccessBit : 0))) | FlagsLvalueBit |
            FlagsRowMajorBit,
...
/** \internal Internal implementation of dense Blocks in the general case. */
    ...
    public:
        ...
        const CoeffReturnType coeff(Index rowId, Index colId) const {
    ...
    protected:
        ...
        XprTypeNested m_xpr;
        const internal::variable_if_dynamic<StorageIndex, (XprType::RowsAtCompileTime == 1 && BlockRows == 1) ? 0
                                                                                                              : Dynamic> m_startRow;
        const internal::variable_if_dynamic<StorageIndex, (XprType::ColsAtCompileTime == 1 && BlockCols == 1) ? 0
                                                                                                              : Dynamic> m_startCol;
