...
// pack a selfadjoint block diagonal for use with the gebp_kernel
        ...
        struct symm_pack_lhs {
            ...
            inline
            void
            pack(Scalar *blockA, const const_blas_data_mapper <Scalar, Index, StorageOrder> &lhs, Index cols, Index i,
                 Index &count) {
                // normal copy
                for (Index k = 0; k < i; k++)
            ...
            void operator()(Scalar *blockA, const Scalar *_lhs, Index lhsStride, Index cols, Index rows) {
                ...
                const Index peeled_mc2 = Pack1 >= 2 * PacketSize ? peeled_mc3 +
                                                                   ((rows - peeled_mc3) / (2 * PacketSize)) *
                                                                   (2 * PacketSize) : 0;
