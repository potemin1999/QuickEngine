...
// Overload default assignPacket behavior for swapping them
        ...
        EIGEN_DEVICE_FUNC
        generic_dense_assignment_kernel(DstEvaluatorTypeT &dst, const SrcEvaluatorTypeT &src, const Functor &func,
                                        DstXprType &dstExpr)
        ...
        void assignPacket(Index row, Index col) {
            ...
            const_cast<SrcEvaluatorTypeT &>(m_src).template writePacket<LoadMode>(row, col,
        ...
        void assignPacket(Index index) {
            ...
            const_cast<SrcEvaluatorTypeT &>(m_src).template writePacket<LoadMode>(index,
                                                                                  m_dst.template packet<StoreMode, PacketType>(
                                                                                          index));
