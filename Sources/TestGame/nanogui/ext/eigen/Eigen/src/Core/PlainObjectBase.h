...
namespace Eigen {
    ...
    public:
        ...
        Index rows() const { return m_storage.rows(); }

        EIGEN_DEVICE_FUNC
                EIGEN_STRONG_INLINE

        Index cols() const { return m_storage.cols(); }
...
#include EIGEN_PLAINOBJECTBASE_PLUGIN
    ...
    protected:
        ...
        void _init2(const T0 &val0, const T1 &val1,
        ...
        void _init1(Index size, typename internal::enable_if<
                ...
                && ((!internal::is_same<typename internal::traits<Derived>::XprKind, ArrayXpr>::value ||
                     Base::SizeAtCompileTime == Dynamic)), T>::type * = 0) {
    ...
    public:
        ...
        template<typename OtherDerived>
        EIGEN_DEVICE_FUNC
        void swap(DenseBase <OtherDerived> const &other) { Base::swap(other.derived()); }
