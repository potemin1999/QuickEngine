...
namespace Eigen {
    ...
    namespace internal {
        ...
        struct scalar_constant_op {
            ...
            const PacketType packetOp() const { return internal::pset1<PacketType>(m_other); }
        ...
        struct scalar_identity_op {
            ...
            const Scalar operator()(IndexType row, IndexType col) const { return row == col ? Scalar(1) : Scalar(0); }
        };
...
// nested expressions).
        ...
        struct linspaced_op {
            ...
            const Scalar operator()(IndexType i) const { return impl(i); }

            template<typename Packet, typename IndexType>
            EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE

            const Packet packetOp(IndexType i) const { return impl.packetOp(i); }
