  ...
  */
    ...
    public:
        ...
        InnerIterator(const InnerIterator &other)
                : m_values(other.m_values), m_indices(other.m_indices), m_outer(other.m_outer), m_id(other.m_id),
                  m_end(other.m_end) {}
    ...
    public:
        ...
        explicit ReverseInnerIterator(const SparseCompressedBase &mat)
                : m_values(mat.valuePtr()), m_indices(mat.innerIndexPtr()), m_outer(0), m_start(0),
                  m_id(mat.nonZeros()) {
            EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived);
        }
    ...
    namespace internal {
        ...
        protected:
            ...
            Index find(Index row, Index col) const {
                ...
                const Index p =
                        std::lower_bound(m_matrix->innerIndexPtr() + start, m_matrix->innerIndexPtr() + end, inner) -
