...
// The two other cases are symmetric.
    ...
    namespace internal {
        ...
        enum {
            CoeffReadCost = HugeCost, Flags = Rhs::Flags & RowMajorBit, Alignment = 0
        }; // FIXME CoeffReadCost & Flags

        typedef sparse_diagonal_product_evaluator<Rhs, typename Lhs::DiagonalVectorType,
                Rhs::Flags & RowMajorBit ? SDP_AsScalarProduct : SDP_AsCwiseProduct> Base;
    ...
    typedef Product <Lhs, Rhs, DefaultProduct> XprType;
    enum {
        CoeffReadCost = HugeCost, Flags = Lhs::Flags & RowMajorBit, Alignment = 0
    }; // FIXME CoeffReadCost & Flags
...
public:
    ...
    public:
        ...
        value() const { return m_coeff * SparseXprInnerIterator::value(); }
