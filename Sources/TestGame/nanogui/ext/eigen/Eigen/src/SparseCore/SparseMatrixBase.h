...
/** \ingroup SparseCore_Module
  ...
  */
    ...
    public:
        ...
        inline Derived &
        const_cast_derived() const { return *static_cast<Derived *>(const_cast<SparseMatrixBase *>(this)); }
...
#undef EIGEN_DOC_BLOCK_ADDONS_INNER_PANEL_IF
    ...
    public:
        ...
        friend std::ostream &operator<<(std::ostream &s, const SparseMatrixBase &m) {
            ...
            if (Flags & RowMajorBit) {
                ...
                if (m.cols() == 1) {
                    ...
                    s << static_cast<const SparseMatrixBase<SparseMatrix < Scalar, RowMajorBit, StorageIndex> >& >
                                                                                                               (trans);
                }
            }
            return s;
        ...
        operator*(const DiagonalBase <OtherDerived> &lhs,
                  const SparseMatrixBase &rhs) { return Product<OtherDerived, Derived>(lhs.derived(), rhs.derived()); }
        ...
        typedef Block<const Derived, IsRowMajor ? 1 : Dynamic, IsRowMajor ? Dynamic
                                                                          : 1, true> ConstInnerVectorReturnType;
        ...
        /** \returns the matrix or vector obtained by evaluating this expression.
          ...
          */
        inline const typename internal::eval<Derived>::type
        eval() const { return typename internal::eval<Derived>::type(derived()); }

        Scalar sum() const;

        inline const SparseView <Derived>
        pruned(const Scalar &reference = Scalar(0),
