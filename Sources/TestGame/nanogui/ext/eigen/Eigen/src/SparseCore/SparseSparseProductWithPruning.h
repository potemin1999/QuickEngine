...
// perform a pseudo in-place sparse * sparse product assuming all matrices are col major
        ...
        struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, ColMajor, ColMajor, RowMajor> {
            ...
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res, const RealScalar &tolerance) {
                ...
                internal::sparse_sparse_product_with_pruning_impl<Lhs, Rhs, SparseTemporaryType>(lhs, rhs, _res,
                                                                                                 tolerance);
                res = _res;
            }
        };
...
//     res = _res.transpose();
        ...
        struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, ColMajor, RowMajor, ColMajor> {
            ...
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res, const RealScalar &tolerance) {
                typedef SparseMatrix<typename ResultType::Scalar, ColMajor, typename Lhs::StorageIndex> ColMajorMatrixRhs;
                ColMajorMatrixRhs colRhs(rhs);
                internal::sparse_sparse_product_with_pruning_impl<Lhs, ColMajorMatrixRhs, ResultType>(lhs, colRhs, res,
                                                                                                      tolerance);
            }
        };
        ...
        struct sparse_sparse_product_with_pruning_selector<Lhs, Rhs, ResultType, RowMajor, ColMajor, ColMajor> {
            ...
            static void run(const Lhs &lhs, const Rhs &rhs, ResultType &res, const RealScalar &tolerance) {
                typedef SparseMatrix<typename ResultType::Scalar, ColMajor, typename Lhs::StorageIndex> ColMajorMatrixLhs;
                ColMajorMatrixLhs colLhs(lhs);
                internal::sparse_sparse_product_with_pruning_impl<ColMajorMatrixLhs, Rhs, ResultType>(colLhs, rhs, res,
                                                                                                      tolerance);
            }
        };
