...
void ColPivHouseholderQR<MatrixType>::computeInPlace() {
    ...
    RealScalar threshold_helper =
            numext::abs2<Scalar>(m_colNormsUpdated.maxCoeff() * NumTraits<Scalar>::epsilon()) / RealScalar(rows);
...
namespace internal {
    ...
    struct Assignment<DstXprType, Inverse <
                                  ColPivHouseholderQR<MatrixType> >, internal::assign_op<typename DstXprType::Scalar, typename ColPivHouseholderQR<MatrixType>::Scalar>, Dense2Dense> {
