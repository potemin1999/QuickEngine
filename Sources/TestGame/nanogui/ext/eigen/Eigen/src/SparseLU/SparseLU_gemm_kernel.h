  ...
  */
        ...
        void sparselu_gemm(Index m, Index n, Index d, const Scalar *A, Index lda, const Scalar *B, Index ldb, Scalar *C,
            ...
            for (Index ib = i0; ib < m; ib += BM) {
                ...
                Index actual_b_end2 =
                        (actual_b / PacketSize) * PacketSize;   // actual number of rows suitable for vectorization
...
#undef WORK
                ...
                if (rd > 0) {
                    for (Index j = 0; j < n; ++j) {
                        ...
                        if (rd == 1) MapVector(C + j * ldc + ib, actual_b) += B[0 + d_end + j * ldb] *
                                                                              ConstMapVector(A + (d_end + 0) * lda + ib,
                                                                                             actual_b);
