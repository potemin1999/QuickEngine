        ...
        void upperbidiagonalization_inplace_unblocked(MatrixType &mat,
            ...
            for (Index k = 0; /* breaks at k==cols-1 below */ ; ++k) {
                ...
                mat.bottomRightCorner(remainingRows - 1, remainingCols)
                        .applyHouseholderOnTheRight(mat.row(k).tail(remainingCols - 1).transpose(), mat.coeff(k, k + 1),
                                                    tempData);
            }
        }
            ...
            for (Index k = 0; k < bs; ++k) {
                ...
                if (k + 1 < bcols) {
                    ...
                    // 6 - Compute x_k = tau_u * ( A*u_k - X_k-1*U_k-1^T*u_k - V_k*Y_k^T*u_k )
                    {
                        ...
                        x_k.noalias() =
                                A.block(k + 1, k + 1, remainingRows - 1, remainingCols) * u_k.transpose(); // bottleneck
...
/** \internal
  ...
  */
        ...
        UpperBidiagonalization<_MatrixType>::computeUnblocked(const _MatrixType &matrix) {
