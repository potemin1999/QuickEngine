...
public:
    ...
    /** \returns the permutation matrix P
      ...
      * \sa permutationQ()
      */
    EIGEN_DEVICE_FUNC inline const PermutationPType
    &
    ...
    rows() const { return m_lu.rows(); }

    EIGEN_DEVICE_FUNC inline Index

    cols() const { return m_lu.cols(); }
...
void FullPivLU<MatrixType>::computeInPlace() {
    ...
    for (Index k = 0; k < size; ++k) {
        ...
        Index
        row_of_biggest_in_corner, col_of_biggest_in_corner;
...
void FullPivLU<_MatrixType>::_solve_impl_transposed(const RhsType &rhs, DstType &dst) const {
    ...
    // Step 4
    PermutationPType
    invp = permutationP().inverse().eval();
...
/***** Implementation of inverse() *****************************************************/
    ...
    struct Assignment<DstXprType, Inverse <
                                  FullPivLU<MatrixType> >, internal::assign_op<typename DstXprType::Scalar, typename FullPivLU<MatrixType>::Scalar>, Dense2Dense> {
