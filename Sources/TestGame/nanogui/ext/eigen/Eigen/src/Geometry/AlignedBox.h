...
/** \geometry_module \ingroup Geometry_Module
  ...
  */
    ...
    public:
        ...
        AlignedBox(const OtherVectorType1 &_min, const OtherVectorType2 &_max) : m_min(_min), m_max(_max) {}
        ...
        dim() const { return AmbientDimAtCompileTime == Dynamic ? m_min.size() : Index(AmbientDimAtCompileTime); }
        ...
        volume() const { return sizes().prod(); }
        ...
        intersection(const AlignedBox &b) const { return AlignedBox(m_min.cwiseMax(b.m_min), m_max.cwiseMin(b.m_max)); }
        ...
        merged(const AlignedBox &b) const { return AlignedBox(m_min.cwiseMin(b.m_min), m_max.cwiseMax(b.m_max)); }
        ...
        EIGEN_DEVICE_FUNC inline explicit
