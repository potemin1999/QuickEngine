...
/** \class RotationBase
  ...
  */
    ...
    public:
        EIGEN_DEVICE_FUNC inline const Derived
        &
        ...
        inverse() const { return derived().inverse(); }

        /** \returns the concatenation of the rotation \c *this with a translation \a t */
        EIGEN_DEVICE_FUNC inline Transform<Scalar, Dim, Isometry>

        operator*(const Translation <Scalar, Dim> &t) const { return Transform<Scalar, Dim, Isometry>(*this) * t; }

        /** \returns the concatenation of the rotation \c *this with a uniform scaling \a s */
        EIGEN_DEVICE_FUNC inline RotationMatrixType

        operator*(const UniformScaling <Scalar> &s) const { return toRotationMatrix() * s.factor(); }
        ...
        operator*(const EigenBase <OtherDerived> &l, const Derived &r) { return l.derived() * r.toRotationMatrix(); }
        ...
        operator*(const Transform<Scalar, Dim, Mode, Options> &t) const { return toRotationMatrix() * t; }

        template<typename OtherVectorType>
        EIGEN_DEVICE_FUNC inline VectorType

        _transformVector(const OtherVectorType &v) const { return toRotationMatrix() * v; }
    };
...
// implementation of the generic product rotation * matrix
        ...
        struct rotation_base_generic_product_selector<RotationDerived, MatrixType, false> {
            ...
            run(const RotationDerived &r, const MatrixType &m) { return r.toRotationMatrix() * m; }
        };
    ...
    struct rotation_base_generic_product_selector<RotationDerived, OtherVectorType, true> {
        ...
        ReturnType run(const RotationDerived &r, const OtherVectorType &v) {
