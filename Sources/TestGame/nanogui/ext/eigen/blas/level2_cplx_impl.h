...
/**  ZHEMV  performs the matrix-vector  operation
  ...
  */
int
EIGEN_BLAS_FUNC(hemv)(const char *uplo, const int *n, const RealScalar *palpha, const RealScalar *pa, const int *lda,
...
/**  ZHPR2  performs the hermitian rank 2 operation
  ...
  *  n by n hermitian matrix, supplied in packed form.
  */
intEIGEN_BLAS_FUNC(hpr2)(char *uplo, int *n, RealScalar *palpha, RealScalar *px, int *incx, RealScalar *py, int *incy,
                         RealScalar *pap) {
...
/**  ZHER2  performs the hermitian rank 2 operation
  ...
  */
intEIGEN_BLAS_FUNC(her2)(char *uplo, int *n, RealScalar *palpha, RealScalar *px, int *incx, RealScalar *py, int *incy,
...
/**  ZGERU  performs the rank 1 operation
  ...
  */
intEIGEN_BLAS_FUNC(geru)(int *m, int *n, RealScalar *palpha, RealScalar *px, int *incx, RealScalar *py, int *incy,
                         RealScalar *pa, int *lda) {
    Scalar *x = reinterpret_cast<Scalar *>(px);
    Scalar *y = reinterpret_cast<Scalar *>(py);
    Scalar *a = reinterpret_cast<Scalar *>(pa);
...
/**  ZGERC  performs the rank 1 operation
  ...
  *  vector and A is an m by n matrix.
  */
intEIGEN_BLAS_FUNC(gerc)(int *m, int *n, RealScalar *palpha, RealScalar *px, int *incx, RealScalar *py, int *incy,
                         RealScalar *pa, int *lda) {
    Scalar *x = reinterpret_cast<Scalar *>(px);
    Scalar *y = reinterpret_cast<Scalar *>(py);
    Scalar *a = reinterpret_cast<Scalar *>(pa);
