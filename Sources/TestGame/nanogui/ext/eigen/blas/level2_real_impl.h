...
// y = alpha*A*x + beta*y
int
EIGEN_BLAS_FUNC(symv)(const char *uplo, const int *n, const RealScalar *palpha, const RealScalar *pa, const int *lda,
...
// C := alpha*x*x' + C
intEIGEN_BLAS_FUNC(syr)(const char *uplo, const int *n, const RealScalar *palpha, const RealScalar *px, const int *incx,
...
int
EIGEN_BLAS_FUNC(syr2)(const char *uplo, const int *n, const RealScalar *palpha, const RealScalar *px, const int *incx,
...
/**  DSPR2  performs the symmetric rank 2 operation
  ...
  *  n by n symmetric matrix, supplied in packed form.
  */
intEIGEN_BLAS_FUNC(spr2)(char *uplo, int *n, RealScalar *palpha, RealScalar *px, int *incx, RealScalar *py, int *incy,
                         RealScalar *pap) {
...
/**  DGER   performs the rank 1 operation
  ...
  */
intEIGEN_BLAS_FUNC(ger)(int *m, int *n, Scalar *palpha, Scalar *px, int *incx, Scalar *py, int *incy, Scalar *pa,
                        int *lda) {
    Scalar *x = reinterpret_cast<Scalar *>(px);
    Scalar *y = reinterpret_cast<Scalar *>(py);
