...
//	IndexType concatDim3 = 1;
    ...
    DataType *gpu_in1_data = static_cast<DataType *>(sycl_device.allocate(
            left.dimensions().TotalSize() * sizeof(DataType)));
    DataType *gpu_in2_data = static_cast<DataType *>(sycl_device.allocate(
            right.dimensions().TotalSize() * sizeof(DataType)));
    ...
    DataType *gpu_out_data1 = static_cast<DataType *>(sycl_device.allocate(
    ...
    DataType *gpu_out_data2 = static_cast<DataType *>(sycl_device.allocate(
    ...
    DataType *gpu_out_data3 = static_cast<DataType *>(sycl_device.allocate(
