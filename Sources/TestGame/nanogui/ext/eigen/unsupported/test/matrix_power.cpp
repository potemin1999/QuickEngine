...
void testSingular(const MatrixType &m_const, const typename MatrixType::RealScalar &tol) {
    ...
    typedef typename internal::conditional<IsComplex,
            TriangularView < MatrixType, Upper>, const MatrixType&>::type TriangularType;
    typename internal::conditional<IsComplex, ComplexSchur < MatrixType>, RealSchur < MatrixType > > ::type
    schur;
    MatrixType T;
