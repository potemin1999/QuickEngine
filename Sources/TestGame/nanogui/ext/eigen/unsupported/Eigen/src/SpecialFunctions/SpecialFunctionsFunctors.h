...
/** \internal
  ...
  */
        ...
        struct scalar_igamma_op : binary_op_base<Scalar, Scalar> {
            ...
            const Scalar operator()(const Scalar &a, const Scalar &x) const {
                using numext::igamma;
                return igamma(a, x);
            }
            ...
            const Packet packetOp(const Packet &a, const Packet &x) const {
...
/** \internal
  ...
  */
        ...
        struct scalar_betainc_op {
            ...
            const Scalar operator()(const Scalar &x, const Scalar &a, const Scalar &b) const {
            ...
            const Packet packetOp(const Packet &x, const Packet &a, const Packet &b) const {
 ...
 */
        ...
        struct scalar_lgamma_op {
            ...
            packetOp(const Packet &a) const { return internal::plgamma(a); }
        };
 ...
 */
        ...
        struct scalar_digamma_op {
            ...
            packetOp(const Packet &a) const { return internal::pdigamma(a); }
        };
 ...
 */
        ...
        struct scalar_zeta_op {
            ...
            operator()(const Scalar &x, const Scalar &q) const {
                using numext::zeta;
                return zeta(x, q);
            }
            ...
            packetOp(const Packet &x, const Packet &q) const { return internal::pzeta(x, q); }
        };
 ...
 */
        ...
        struct scalar_polygamma_op {
            ...
            operator()(const Scalar &n, const Scalar &x) const {
            ...
            packetOp(const Packet &n, const Packet &x) const { return internal::ppolygamma(n, x); }
        };
 ...
 */
        ...
        struct scalar_erf_op {
            ...
            packetOp(const Packet &a) const { return internal::perf(a); }
        };
 ...
 */
        ...
        struct scalar_erfc_op {
            ...
            packetOp(const Packet &a) const { return internal::perfc(a); }
        };
