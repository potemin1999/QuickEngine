...
#define EIGEN_EULER_ANGLES_CLASS_STATIC_ASSERT(COND, MSG) typedef char static_assertion_##MSG[(COND)?1:-1]
    ...
    public:
        ...
        enum {
            ...
            // by Z, or Z is followed by X; otherwise it is odd.
                    IsOdd = ((AlphaAxisAbs) % 3 == (BetaAxisAbs - 1) % 3) ? 0
                                                                          : 1, /*!< whether the Euler system is odd */
            IsEven = IsOdd ? 0 : 1, /*!< whether the Euler system is even */

            IsTaitBryan = ((unsigned) AlphaAxisAbs != (unsigned) GammaAxisAbs) ? 1
                                                                               : 0 /*!< whether the Euler system is Tait-Bryan */
        };
    ...
    private:
        ...
        static void
        CalcEulerAngles_imp(Matrix<typename MatrixBase<Derived>::Scalar, 3, 1> &res, const MatrixBase <Derived> &mat,
            ...
            const Scalar Rsum = sqrt(
                    (mat(I, I) * mat(I, I) + mat(I, J) * mat(I, J) + mat(J, K) * mat(J, K) + mat(K, K) * mat(K, K)) /
                    2);
        ...
        static void CalcEulerAngles_imp(Matrix<typename MatrixBase<Derived>::Scalar, 3, 1> &res,
            ...
            const Scalar Rsum = sqrt(
                    (mat(I, J) * mat(I, J) + mat(I, K) * mat(I, K) + mat(J, I) * mat(J, I) + mat(K, I) * mat(K, I)) /
                    2);
