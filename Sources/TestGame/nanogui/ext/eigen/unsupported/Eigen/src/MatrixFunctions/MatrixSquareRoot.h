...
// post: sqrtT.block(i,i,2,2) is square root of T.block(i,i,2,2)
        ...
        void matrix_sqrt_quasi_triangular_2x2_diagonal_block(const MatrixType &T, typename MatrixType::Index i,
                                                             ResultType &sqrtT) {
...
// post: sqrtT(i,j) has the correct value
        template<typename MatrixType, typename ResultType>
        void matrix_sqrt_quasi_triangular_1x1_off_diagonal_block(const MatrixType &T, typename MatrixType::Index i,
...
// similar to compute1x1offDiagonalBlock()
        template<typename MatrixType, typename ResultType>
        void matrix_sqrt_quasi_triangular_1x2_off_diagonal_block(const MatrixType &T, typename MatrixType::Index i,
                                                                 typename MatrixType::Index j, ResultType &sqrtT) {
            typedef typename traits<MatrixType>::Scalar Scalar;
...
// similar to compute1x1offDiagonalBlock()
        template<typename MatrixType, typename ResultType>
        void matrix_sqrt_quasi_triangular_2x1_off_diagonal_block(const MatrixType &T, typename MatrixType::Index i,
                                                                 typename MatrixType::Index j, ResultType &sqrtT) {
            typedef typename traits<MatrixType>::Scalar Scalar;
...
// solves the equation A X + X B = C where all matrices are 2-by-2
        ...
        void
        matrix_sqrt_quasi_triangular_solve_auxiliary_equation(MatrixType &X, const MatrixType &A, const MatrixType &B,
                                                              const MatrixType &C) {
            typedef typename traits<MatrixType>::Scalar Scalar;
...
// similar to compute1x1offDiagonalBlock()
        template<typename MatrixType, typename ResultType>
        void matrix_sqrt_quasi_triangular_2x2_off_diagonal_block(const MatrixType &T, typename MatrixType::Index i,
                                                                 typename MatrixType::Index j, ResultType &sqrtT) {
            typedef typename traits<MatrixType>::Scalar Scalar;
    ...
    void matrix_sqrt_triangular(const MatrixType &arg, ResultType &result) {
        ...
        for (Index j = 1; j < arg.cols(); j++) {
            for (Index i = j - 1; i >= 0; i--) {
                ...
                Scalar tmp = (result.row(i).segment(i + 1, j - i - 1) *
                              result.col(j).segment(i + 1, j - i - 1)).value();
