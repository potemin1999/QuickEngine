 ...
 */
            ...
            struct polevl {
                ...
                Scalar run(const Scalar x, const Scalar coef[]) {
            ...
            struct polevl<Scalar, 0> {
                ...
                Scalar run(const Scalar, const Scalar coef[]) {
                    return coef[0];
                }
            };
 ...
 *****************************************************************************/
        ...
        struct zeta_impl_series<float> {
            ...
            bool run(float &a, float &b, float &s, const float x, const float machep) {
                int i = 0;
                while (i < 9) {
                    i += 1;
                    a += 1.0f;
        ...
        struct zeta_impl_series<double> {
            ...
            bool run(double &a, double &b, double &s, const double x, const double machep) {
                int i = 0;
                while ((i < 9) || (a <= 9.0)) {
                    i += 1;
                    a += 1.0;
 ...
 ************************************************************************************************/
        ...
        struct betainc_impl {
            ...
            Scalar run(Scalar a, Scalar b, Scalar x) {
                EIGEN_STATIC_ASSERT((internal::is_same<Scalar, Scalar>::value == false),
                                    THIS_TYPE_IS_NOT_SUPPORTED);
                return Scalar(0);
            }
    ...
    namespace numext {
        ...
        lgamma(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(lgamma, Scalar)
            ::run(x);
        }
        ...
        digamma(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(digamma, Scalar)
            ::run(x);
        }
        ...
        zeta(const Scalar &x, const Scalar &q) {
            return EIGEN_MATHFUNC_IMPL(zeta, Scalar)
            ::run(x, q);
        }
        ...
        polygamma(const Scalar &n, const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(polygamma, Scalar)
            ::run(n, x);
        }
        ...
        erf(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(erf, Scalar)
            ::run(x);
        }
        ...
        erfc(const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(erfc, Scalar)
            ::run(x);
        }
        ...
        igamma(const Scalar &a, const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(igamma, Scalar)
            ::run(a, x);
        }
        ...
        igammac(const Scalar &a, const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(igammac, Scalar)
            ::run(a, x);
        }
        ...
        betainc(const Scalar &a, const Scalar &b, const Scalar &x) {
            return EIGEN_MATHFUNC_IMPL(betainc, Scalar)
            ::run(a, b, x);
        }
