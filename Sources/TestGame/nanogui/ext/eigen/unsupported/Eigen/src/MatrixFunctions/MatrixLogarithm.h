...
/** \brief Compute logarithm of 2x2 triangular matrix. */
        ...
        void matrix_log_compute_2x2(const MatrixType &A, MatrixType &result) {
            ...
            if (y == Scalar(0)) {
                ...
                int unwindingNumber = static_cast<int>(ceil(
                        (imag(logA11 - logA00) - RealScalar(EIGEN_PI)) / RealScalar(2 * EIGEN_PI)));
...
/* \brief Get suitable degree for Pade approximation. (specialized for RealScalar = long double) */
        inline int matrix_log_get_pade_degree(long double normTminusI) {
            ...
            const long double maxNormForPade[] = {5.48256690357782863103e-3L /* degree = 3 */,
                                                  ...
                                                  5.84603923897347449857e-2L, 1.08486423756725170223e-1L,
...
/** \brief Compute logarithm of triangular matrices with size > 2. 
  * \details This uses a inverse scale-and-square algorithm. */
        ...
        void matrix_log_compute_big(const MatrixType &A, MatrixType &result) {
            ...
            while (true) {
                RealScalar normTminusI = (T - MatrixType::Identity(T.rows(),
