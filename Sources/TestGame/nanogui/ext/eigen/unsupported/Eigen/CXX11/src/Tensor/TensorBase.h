...
/** \class TensorBase
  ...
  */
    ...
    public:
        ...
        const TensorCwiseNullaryOp<internal::UniformRandomGenerator<Scalar>, const Derived>
        random() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_sqrt_op<Scalar>, const Derived>
        sqrt() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_sign_op<Scalar>, const Derived>
        sign() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_rsqrt_op<Scalar>, const Derived>
        rsqrt() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_square_op<Scalar>, const Derived>
        square() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_cube_op<Scalar>, const Derived>
        cube() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_tanh_op<Scalar>, const Derived>
        tanh() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_lgamma_op<Scalar>, const Derived>
        lgamma() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_digamma_op<Scalar>, const Derived>
        digamma() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_erf_op<Scalar>, const Derived>
        erf() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_erfc_op<Scalar>, const Derived>
        erfc() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_sigmoid_op<Scalar>, const Derived>
        sigmoid() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_exp_op<Scalar>, const Derived>
        exp() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_expm1_op<Scalar>, const Derived>
        expm1() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_log_op<Scalar>, const Derived>
        log() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_log1p_op<Scalar>, const Derived>
        log1p() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_abs_op<Scalar>, const Derived>
        abs() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_conjugate_op<Scalar>, const Derived>
        conjugate() const {
        ...
        EIGEN_DEVICE_FUNC
                EIGEN_STRONG_INLINE
        const TensorCwiseUnaryOp <internal::bind2nd_op<internal::scalar_pow_op < Scalar, Scalar>>, const Derived>
        pow(Scalar
        exponent) const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_real_op<Scalar>, const Derived>
        real() const {
        ...
        EIGEN_DEVICE_FUNC
                EIGEN_STRONG_INLINE
        const TensorCwiseUnaryOp <internal::bind2nd_op<internal::scalar_sum_op < Scalar, Scalar>>, const Derived>
        ...
        EIGEN_DEVICE_FUNC
                EIGEN_STRONG_INLINE
        const TensorCwiseUnaryOp <internal::bind2nd_op<internal::scalar_difference_op < Scalar, Scalar>>, const Derived>

        operator-(Scalar rhs) const {
            EIGEN_STATIC_ASSERT(
                    (NumTraits<Scalar>::IsSigned || internal::is_same<Scalar, const std::complex<float> >::value),
        ...
        EIGEN_DEVICE_FUNC
                EIGEN_STRONG_INLINE
        const TensorCwiseUnaryOp <internal::bind2nd_op<internal::scalar_product_op < Scalar, Scalar>>, const Derived>
        ...
        EIGEN_DEVICE_FUNC
                EIGEN_STRONG_INLINE
        const TensorCwiseUnaryOp <internal::bind2nd_op<internal::scalar_quotient_op < Scalar, Scalar>>, const Derived>
        ...
        const TensorCwiseUnaryOp<internal::scalar_mod_op<Scalar>, const Derived>
        operator%(Scalar rhs) const {
        ...
        const TensorCwiseBinaryOp<internal::scalar_max_op<Scalar>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
        ...
        const TensorCwiseBinaryOp<internal::scalar_min_op<Scalar>, const Derived, const TensorCwiseNullaryOp<internal::scalar_constant_op<Scalar>, const Derived> >
        ...
        const TensorCwiseUnaryOp<internal::scalar_round_op<Scalar>, const Derived>
        round() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_ceil_op<Scalar>, const Derived>
        ceil() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_floor_op<Scalar>, const Derived>
        floor() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_isnan_op<Scalar>, const Derived>
        (isnan)() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_isinf_op<Scalar>, const Derived>
        (isinf)() const {
        ...
        const TensorCwiseUnaryOp<internal::scalar_isfinite_op<Scalar>, const Derived>
        (isfinite)() const {
        ...
        select(const ThenDerived &thenTensor, const ElseDerived &elseTensor) const {
            return TensorSelectOp<const Derived, const ThenDerived, const ElseDerived>(derived(), thenTensor.derived(),
                                                                                       elseTensor.derived());
        }
        ...
        contract(const OtherDerived &other, const Dimensions &dims) const {
            return TensorContractionOp<const Dimensions, const Derived, const OtherDerived>(derived(), other.derived(),
                                                                                            dims);
        }
        ...
        convolve(const KernelDerived &kernel, const Dimensions &dims) const {
            return TensorConvolutionOp<const Dimensions, const Derived, const KernelDerived>(derived(),
                                                                                             kernel.derived(), dims);
        }
        ...
        sum(const Dims &dims) const {
            return TensorReductionOp < internal::SumReducer < CoeffReturnType > ,
            const Dims, const Derived>(derived(), dims, internal::SumReducer<CoeffReturnType>());
        }
        ...
        sum() const {
            ...
            return TensorReductionOp < internal::SumReducer < CoeffReturnType > ,
            const DimensionList <Index, NumDimensions>, const Derived>(derived(), in_dims, internal::SumReducer<CoeffReturnType>());
        }
        ...
        mean(const Dims &dims) const {
            return TensorReductionOp < internal::MeanReducer < CoeffReturnType > ,
            const Dims, const Derived>(derived(), dims, internal::MeanReducer<CoeffReturnType>());
        }
        ...
        mean() const {
            DimensionList <Index, NumDimensions> in_dims;
            return TensorReductionOp < internal::MeanReducer < CoeffReturnType > ,
            const DimensionList <Index, NumDimensions>, const Derived>(derived(), in_dims, internal::MeanReducer<CoeffReturnType>());
        }
        ...
        prod(const Dims &dims) const {
            return TensorReductionOp < internal::ProdReducer < CoeffReturnType > ,
            const Dims, const Derived>(derived(), dims, internal::ProdReducer<CoeffReturnType>());
        }
        ...
        prod() const {
            DimensionList <Index, NumDimensions> in_dims;
            return TensorReductionOp < internal::ProdReducer < CoeffReturnType > ,
            const DimensionList <Index, NumDimensions>, const Derived>(derived(), in_dims, internal::ProdReducer<CoeffReturnType>());
        }
        ...
        maximum(const Dims &dims) const {
            return TensorReductionOp < internal::MaxReducer < CoeffReturnType > ,
            const Dims, const Derived>(derived(), dims, internal::MaxReducer<CoeffReturnType>());
        }
        ...
        maximum() const {
            DimensionList <Index, NumDimensions> in_dims;
            return TensorReductionOp < internal::MaxReducer < CoeffReturnType > ,
            const DimensionList <Index, NumDimensions>, const Derived>(derived(), in_dims, internal::MaxReducer<CoeffReturnType>());
        }
        ...
        minimum(const Dims &dims) const {
            return TensorReductionOp < internal::MinReducer < CoeffReturnType > ,
            const Dims, const Derived>(derived(), dims, internal::MinReducer<CoeffReturnType>());
        }
        ...
        minimum() const {
            DimensionList <Index, NumDimensions> in_dims;
            return TensorReductionOp < internal::MinReducer < CoeffReturnType > ,
            const DimensionList <Index, NumDimensions>, const Derived>(derived(), in_dims, internal::MinReducer<CoeffReturnType>());
        }
        ...
        argmax() const {
            ...
            const Derived>(derived(), internal::ArgMaxTupleReducer < Tuple < Index, CoeffReturnType > >
                                                                                    (), -1, in_dims);
        }
        ...
        argmin() const {
            ...
            return TensorTupleReducerOp <
                   internal::ArgMinTupleReducer < Tuple < Index, CoeffReturnType > >,
            const array <Index, NumDimensions>,
            const Derived>(derived(), internal::ArgMinTupleReducer < Tuple < Index, CoeffReturnType > >
                                                                                    (), -1, in_dims);
        }
        ...
        extract_image_patches(const Index patch_rows = 1, const Index patch_cols = 1,
            ...
            return TensorImagePatchOp<Dynamic, Dynamic, const Derived>(derived(), patch_rows, patch_cols, row_stride,
                                                                       col_stride,
                                                                       in_row_stride, in_col_stride, 1, 1, padding_type,
                                                                       padding_value);
        }
        ...
        extract_image_patches(const Index patch_rows, const Index patch_cols,
            ...
            return TensorImagePatchOp<Dynamic, Dynamic, const Derived>(derived(), patch_rows, patch_cols, row_stride,
                                                                       col_stride,
                                                                       in_row_stride, in_col_stride, row_inflate_stride,
                                                                       col_inflate_stride,
        ...
        extract_volume_patches(const Index patch_planes, const Index patch_rows, const Index patch_cols,
                               ...
                               const PaddingType padding_type = PADDING_SAME,
                               const Scalar padding_value = Scalar(0)) const {
            return TensorVolumePatchOp<Dynamic, Dynamic, Dynamic, const Derived>(derived(), patch_planes, patch_rows,
                                                                                 patch_cols, plane_stride, row_stride,
                                                                                 col_stride, 1, 1, 1, 1, 1, 1,
        ...
        extract_volume_patches(const Index patch_planes, const Index patch_rows, const Index patch_cols,
                               ...
                               const Index plane_inflate_stride, const Index row_inflate_stride,
            ...
            return TensorVolumePatchOp<Dynamic, Dynamic, Dynamic, const Derived>(derived(), patch_planes, patch_rows,
                                                                                 patch_cols, plane_stride, row_stride,
                                                                                 col_stride, 1, 1, 1,
                                                                                 plane_inflate_stride,
                                                                                 row_inflate_stride, col_inflate_stride,
                                                                                 padding_top_z, padding_bottom_z,
        ...
        pad(const PaddingDimensions &padding) const {
            return TensorPaddingOp<const PaddingDimensions, const Derived>(derived(), padding,
                                                                           internal::scalar_cast_op<int, Scalar>()(0));
        }
        ...
        const TensorCustomBinaryOp<const CustomBinaryFunc, const Derived, const OtherDerived>
        customOp(const OtherDerived &other, const CustomBinaryFunc &op) const {
            return TensorCustomBinaryOp<const CustomBinaryFunc, const Derived, const OtherDerived>(derived(), other,
                                                                                                   op);
        }
    ...
    protected:
        template<typename Scalar, int NumIndices, int Options, typename IndexType> friend
        class Tensor;

        template<typename Scalar, typename Dimensions, int Option, typename IndexTypes> friend
        class TensorFixedSize;

        template<typename OtherDerived, int AccessLevel> friend
        class TensorBase;
    ...
    public:
        ...
        template<typename OtherDerived, int OtherAccessLevel> friend
        class TensorBase;
