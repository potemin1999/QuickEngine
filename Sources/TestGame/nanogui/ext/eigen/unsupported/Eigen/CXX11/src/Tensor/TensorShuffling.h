...
public:
    ...
    TensorShufflingOp(const XprType &expr, const Shuffle &shuffle)
    ...
    shufflePermutation() const { return m_shuffle; }
    ...
    TensorShufflingOp &operator=(const TensorShufflingOp &other) {
    ...
    TensorShufflingOp &operator=(const OtherDerived &other) {
...
struct TensorEvaluator<const TensorShufflingOp<Shuffle, ArgType>, Device> {
    ...
    *
    ...
    // required by sycl
    EIGEN_STRONG_INLINE const Shuffle
    &

    shufflePermutation() const { return m_shuffle; }

    // required by sycl
    EIGEN_STRONG_INLINE const TensorEvaluator<ArgType, Device>
    &
