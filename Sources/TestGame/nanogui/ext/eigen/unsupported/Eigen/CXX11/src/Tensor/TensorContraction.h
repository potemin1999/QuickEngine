...
/** \class TensorContraction
  ...
  */
    namespace internal {
        ...
        // From NumDims below.
        static const int NumDimensions = traits<RhsXprType>::NumDimensions + traits<RhsXprType>::NumDimensions -
                                         2 * array_size<Dimensions>::value;
...
template<typename Dimensions, typename LhsXprType, typename RhsXprType>
struct nested<TensorContractionOp < Dimensions, LhsXprType, RhsXprType>, 1, typename eval<
...
struct traits<TensorEvaluator<const TensorContractionOp <Indices_, LeftArgType_, RightArgType_>, Device_> > {
    ...
    // From NumDims below.
    static const int NumDimensions = traits<LeftArgType_>::NumDimensions + traits<RightArgType_>::NumDimensions -
                                     2 * array_size<Indices_>::value;
};
        ...
        for (Index i2 = 0; i2 < m; i2 += mc) {
            ...
            for (Index k2 = 0; k2 < k; k2 += kc) {
                ...
                for (Index j2 = 0; j2 < n; j2 += nc) {
                    ...
                    gebp(output.getSubMapper(i2, j2), blockA, blockB, actual_mc, actual_kc, actual_nc, Scalar(1), -1,
                         -1, 0, 0);
                }
            }
        }
...
protected:
    ...
    void EnableXSMMIfPossible(const array <IndexPair<Index>, ContractDims> &eval_op_indices) {
