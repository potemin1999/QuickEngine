...
/** \internal
  ...
  */
        ...
        template<typename T, typename Tail=empty_list>
        struct type_list {
            typedef T HeadType;
...
/* numeric list */
        ...
        template<std::size_t index, class NList>
        struct get;
        ...
        typename Head::type array_get(const type_list<Head, Tail> &) {
            return get<I, type_list<Head, Tail> >::value;
        }
        ...
        typename NList::HeadType::type array_prod(const NList &) {
        ...
        const T &array_get(const std::vector <T> &a) {
            return a[I];
        }

        struct sum_op {
            template<typename A, typename B>
            static inline bool run(A a, B b) { return a + b; }
        };
        ...
        struct not_op {
            template<typename A>
            static inline bool run(A a) { return !a; }
        };
        ...
        struct greater_equal_zero_op {
            template<typename A>
            static inline bool run(A a) { return a >= 0; }
        };
