 ...
 */
        ...
        struct scalar_mod_op {
            ...
            operator()(const Scalar &a) const { return a % m_divisor; }
        ...
        struct functor_traits<scalar_mod_op<Scalar> > {
            enum {
                Cost = scalar_div_cost<Scalar, false>::value, PacketAccess = false
            };
        };
...
// Standard reduction functors
        ...
        struct SumReducer {
            ...
            void reducePacket(const Packet &p, Packet *accum) const {
            ...
            Packet finalizePacket(const Packet &vaccum) const {
                return vaccum;
            }
            ...
            T finalizeBoth(const T saccum, const Packet &vaccum) const {
                internal::scalar_sum_op<T> sum_op;
        ...
        struct MeanReducer {
            ...
            void reducePacket(const Packet &p, Packet *accum) {
                (*accum) = padd<Packet>(*accum, p);
                packetCount_++;
            }
        ...
        struct AndReducer {
            ...
            void reduce(bool t, bool *accum) const {
                *accum = *accum && t;
            }
            ...
            bool finalize(bool accum) const {
                return accum;
            }
        };
...
// Argmin/Argmax reducers
        ...
        public:
            ...
            operator()(const array <Index, NumDims> &coordinates) const {
                ...
                for (size_t i = 0; i < NumDims; ++i) {
                    T
                    offset = coordinates[i] - m_means[i];
