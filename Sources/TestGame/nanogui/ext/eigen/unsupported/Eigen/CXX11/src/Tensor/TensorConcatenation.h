...
template<typename Axis, typename LhsXprType, typename RhsXprType>
struct nested<TensorConcatenationOp < Axis, LhsXprType, RhsXprType>, 1, typename eval<
...
public:
    ...
    TensorConcatenationOp &operator=(const TensorConcatenationOp &other) {
    ...
    TensorConcatenationOp &operator=(const OtherDerived &other) {
...
struct TensorEvaluator<const TensorConcatenationOp<Axis, LeftArgType, RightArgType>, Device> {
    ...
    TensorEvaluator(const XprType &op, const Device &device)
        ...
        EIGEN_STATIC_ASSERT((static_cast<int>(TensorEvaluator<LeftArgType, Device>::Layout) ==
                             static_cast<int>(TensorEvaluator<RightArgType, Device>::Layout) || NumDims == 1),
