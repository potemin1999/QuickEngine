...
public:
    ...
    EIGEN_DEVICE_FUNC
    const ReverseDimensions
    &

    reverse() const { return m_reverse_dims; }
    ...
    TensorReverseOp &operator=(const TensorReverseOp &other) {
    ...
    TensorReverseOp &operator=(const OtherDerived &other) {
