...
// Generic evaluator
    ...
    struct TensorEvaluator {
        ...
        EIGEN_DEVICE_FUNC typename internal::traits<Derived>::template MakePointer<Scalar>::Type
...
// Default evaluator for rvalues
    ...
    struct TensorEvaluator<const Derived, Device> {
        ...
        CoeffReturnType coeff(const array <DenseIndex, NumCoords> &coords) const {
            eigen_assert(m_data);
            const Index index = (static_cast<int>(Layout) == static_cast<int>(ColMajor)) ? m_dims.IndexOfColMajor(
                    coords)
                                                                                         : m_dims.IndexOfRowMajor(
                            coords);
            return loadConstant(m_data + index);
        }
        ...
        EIGEN_DEVICE_FUNC typename internal::traits<Derived>::template MakePointer<const Scalar>::Type
...
// -------------------- CwiseNullaryOp --------------------
    ...
    struct TensorEvaluator<const TensorCwiseNullaryOp <NullaryOp, ArgType>, Device> {
        ...
        dimensions() const { return m_argImpl.dimensions(); }

        EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE

        bool evalSubExprsIfNeeded(CoeffReturnType *) { return true; }
...
// -------------------- CwiseUnaryOp --------------------
    ...
    struct TensorEvaluator<const TensorCwiseUnaryOp <UnaryOp, ArgType>, Device> {
        ...
        enum {
            ...
            PacketAccess =
            TensorEvaluator<ArgType, Device>::PacketAccess & internal::functor_traits<UnaryOp>::PacketAccess,
            Layout = TensorEvaluator<ArgType, Device>::Layout,
            CoordAccess = false,  // to be implemented
            RawAccess = false
        };
...
// -------------------- CwiseBinaryOp --------------------
    ...
    struct TensorEvaluator<const TensorCwiseBinaryOp <BinaryOp, LeftArgType, RightArgType>, Device> {
        ...
        enum {
            IsAligned =
            TensorEvaluator<LeftArgType, Device>::IsAligned & TensorEvaluator<RightArgType, Device>::IsAligned,
            PacketAccess =
        ...
        EIGEN_DEVICE_FUNC TensorEvaluator(const XprType &op, const Device &device)
            ...
            EIGEN_STATIC_ASSERT((static_cast<int>(TensorEvaluator<LeftArgType, Device>::Layout) ==
                                 ...
                                 internal::traits<XprType>::NumDimensions <= 1), YOU_MADE_A_PROGRAMMING_MISTAKE);
...
// -------------------- CwiseTernaryOp --------------------
    ...
    struct TensorEvaluator<const TensorCwiseTernaryOp <TernaryOp, Arg1Type, Arg2Type, Arg3Type>, Device> {
        ...
        enum {
            ...
            PacketAccess =
            TensorEvaluator<Arg1Type, Device>::PacketAccess & TensorEvaluator<Arg2Type, Device>::PacketAccess &
...
// -------------------- SelectOp --------------------
    ...
    struct TensorEvaluator<const TensorSelectOp <IfArgType, ThenArgType, ElseArgType>, Device> {
        ...
        enum {
            IsAligned =
            TensorEvaluator<ThenArgType, Device>::IsAligned & TensorEvaluator<ElseArgType, Device>::IsAligned,
            PacketAccess =
