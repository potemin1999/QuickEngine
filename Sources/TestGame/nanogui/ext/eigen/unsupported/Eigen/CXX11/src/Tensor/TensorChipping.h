...
public:
    ...
    dim() const { return m_dim.actualDim(); }
    ...
    TensorChippingOp &operator=(const TensorChippingOp &other) {
    ...
    TensorChippingOp &operator=(const OtherDerived &other) {
