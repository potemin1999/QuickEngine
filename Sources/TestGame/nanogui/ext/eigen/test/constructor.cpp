...
void test_constructor() {
    for (int i = 0; i < g_repeat; i++) {
        ...
        CALL_SUBTEST_1(ctor_init1(MatrixXcf(internal::random<int>(1, EIGEN_TEST_MAX_SIZE),
                                            internal::random<int>(1, EIGEN_TEST_MAX_SIZE))));
        CALL_SUBTEST_1(ctor_init1(MatrixXi(internal::random<int>(1, EIGEN_TEST_MAX_SIZE),
                                           internal::random<int>(1, EIGEN_TEST_MAX_SIZE))));
    }
    {
